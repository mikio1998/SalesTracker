...
final class EditQuantityView: XibView {
    ...
    private var countNum: Int {
        didSet {
            ...
            self.editButton.backgroundColor = countNum == 0 ? #colorLiteral(red: 1, green: 0, blue: 0, alpha: 1) : #colorLiteral(red: 0.2404436469, green: 0.70667243, blue: 0.5386798978, alpha: 1)
        }
    }
